import java.util.Scanner;
 ...
 public class Jogador {
	...
	public Jogador(Jogador outroJogador) {
	    this.id = outroJogador.id;
	    this.nome = outroJogador.nome;
	    this.altura = outroJogador.altura;
	    this.peso = outroJogador.peso;
	    this.universidade = outroJogador.universidade;
	    this.anoNascimento = outroJogador.anoNascimento;
	    this.cidadeNascimento = outroJogador.cidadeNascimento;
	    this.estadoNascimento = outroJogador.estadoNascimento;
	}
